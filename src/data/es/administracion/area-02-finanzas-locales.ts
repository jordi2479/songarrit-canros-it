  ...
  "propuestas": [
    {
        ...
        "viabilidad": "Sí con la exportación semanal de saldos vivos de clientes desde el ERP local. No ejecuta bloqueos bancarios ni llamadas automáticas; asiste al mostrador.",
        "veredicto": "Sí con la exportación semanal de saldos vivos de clientes desde el ERP local. No ejecuta bloqueos bancarios ni llamadas automáticas; asiste al mostrador.",
        "facilidad": "Medio",
        "riesgo": "Bajo",
        "beneficio": "Alto",
        "acceso": "lectura",
