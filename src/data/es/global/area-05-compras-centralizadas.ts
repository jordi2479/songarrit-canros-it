    ...
    "propuestas": [
        {
            ...
            "cat_id": "compras",
            "pasos": [
                "Consolidar el volumen anual de compras agrupadas de Son Garrit y Ca'n Ros para los 15 principales proveedores.",
                "Solicitar reunión conjunta con los delegados comerciales de las marcas presentando la cifra global del grupo.",
                "Negociar un tramo de descuento unificado y condiciones de portes compartidos aplicables a ambos códigos de cliente.",
                "Actualizar las fichas de tarifas y condiciones de compra en los sistemas de ambas ferreterías."
            ]
        },
        {
            ...
            "cat_id": "compras",
            "pasos": [
                "Crear una agenda compartida con los días de corte de pedidos y días de entrega fija por fabricante.",
                "Establecer un canal de mensajería interno o checklist conjunto antes de cerrar pedidos mínimos que eviten portes.",
                "Asignar turnos de emisión de pedidos para no duplicar esfuerzos de gestión administrativa.",
                "Revisar el ahorro generado en portes y costes de transporte al finalizar el primer trimestre."
            ]
        },
        {
            ...
            "cat_id": "compras",
            "pasos": [
                "Recopilar los contratos y acuerdos anuales de rápel por volumen firmados con los fabricantes clave.",
                "Montar una hoja de seguimiento del acumulado mensual de compras frente al umbral necesario para cobrar el rappel.",
                "Emitir una alerta 45 días antes del cierre de año si faltan pocas compras para alcanzar el siguiente escalón de bonificación.",
                "Gestionar la reclamación y cobro puntual de las liquidaciones de rápel vencidas a principios de año."
            ]
        }
    ]
};
