    ...
    "propuestas": [
        {
            ...
            "cat_id": "direccion",
            "pasos": [
                "Analizar el catálogo activo de ambas tiendas para identificar referencias exclusivas de Palma y de Campos.",
                "Determinar qué familias especializadas de una tienda (ej. fontanería técnica o cerrajería) deben abrirse al catálogo global.",
                "Publicar el vademécum de especialidades para que ambos mostradores puedan ofrecer la gama completa del grupo.",
                "Revisar trimestralmente la demanda cruzada generada para decidir stock permanente en el segundo centro."
            ]
        },
        {
            ...
            "cat_id": "direccion",
            "pasos": [
                "Homogeneizar el plan de cuentas y la imputación de gastos generales entre ambas sociedades mercantiles.",
                "Configurar un modelo de agregación financiera mensual que sume ingresos y reste costes de estructura conjuntos.",
                "Calcular el EBITDA consolidado y el peso porcentual de cada tienda en la rentabilidad neta.",
                "Entregar mensualmente a la propiedad el estado consolidado para decisiones de inversión, financiación o dividendos."
            ]
        },
        {
            ...
            "cat_id": "direccion",
            "pasos": [
                "Reunir a los responsables de ambas tiendas para calendarizar las 6 campañas clave del año (poda, piscinas, reformas, estufas).",
                "Consolidar la previsión de compras conjuntas con 60 días de antelación para negociar mejores condiciones de partida.",
                "Diseñar los materiales publicitarios comunes (folletos físicos, banners y cartelería de mostrador).",
                "Lanzar simultáneamente la campaña en Palma y Campos, midiendo la venta comparada y rotación final."
            ]
        }
    ]
};
