    ...
    "propuestas": [
        {
            ...
            "cat_id": "seguridad",
            "pasos": [
                "Identificar las referencias de alta merma por valor o susceptibilidad de robo (herramienta eléctrica, baterías, cerraduras).",
                "Implantar vitrinas con llave o alarmas físicas en el lineal para artículos con PVP superior a 60 €.",
                "Asignar responsables diarios de la custodia de llaves de almacén restringido y recuento físico de vitrinas al cierre.",
                "Evaluar en el inventario trimestral la disminución efectiva de la merma desconocida en estas categorías críticas."
            ]
        },
        {
            ...
            "cat_id": "seguridad",
            "pasos": [
                "Confeccionar una lista de verificación mensual con puntos clave: extintores, luces de emergencia, escaleras y carretillas elevadoras.",
                "Asignar la revisión física el primer martes de cada mes al responsable de seguridad de cada centro.",
                "Registrar las incidencias detectadas en una ficha de mantenimiento con plazo máximo de reparación o sustitución.",
                "Archivar los certificados y revisiones oficiales para superar con solvencia cualquier inspección de trabajo o mutua."
            ]
        },
        {
            ...
            "cat_id": "seguridad",
            "pasos": [
                "Habilitar un protocolo inmediato cuando un dependiente detecte un descuadre en estantería o intento de hurto.",
                "Registrar el incidente de forma anónima y objetiva: día, hora, pasillo y valor estimado de la mercancía afectada.",
                "Revisar las grabaciones del circuito cerrado de televisión (CCTV) para identificar patrones o puntos ciegos en la sala de ventas.",
                "Reubicar la mercancía más vulnerable en zonas de paso con supervisión visual directa desde las cajas."
            ]
        }
    ]
};
