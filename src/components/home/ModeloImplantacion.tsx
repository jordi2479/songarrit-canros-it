  ...
  const t = useMemo(() => {
    if (isCa) {
      return {
        ...
        roleMobile: "La meva proposta és actuar com a figura interna de confiança per connectar la visió de Direcció amb la realitat de la botiga, modernitzant el grup sense intermediaris externs ni aturar l'activitat.",
        roleDesktopPrefix: "Per liderar aquesta etapa, la meva proposta és actuar com a ",
        roleDesktopHighlight1: "facilitador d'innovació operativa",
        roleDesktopMiddle: ": una ",
        roleDesktopHighlight2: "figura interna i de màxima confiança",
        roleDesktopEnd: " que coneix el negoci i la realitat de la botiga, i domina les eines IT. La meva tasca és assegurar una modernització fluida, sense intermediaris externs i alliberant temps i càrrega executiva a la Direcció.",
    ...
    if (isEn) {
      return {
        ...
        roleMobile: "My proposal is to act as an internal trusted figure connecting leadership vision with store reality, modernizing the group without external agencies or business downtime.",
        roleDesktopPrefix: "To lead this stage, my proposal is to act as an ",
        roleDesktopHighlight1: "operational innovation facilitator",
        roleDesktopMiddle: ": a ",
        roleDesktopHighlight2: "trusted internal figure",
        roleDesktopEnd: " who understands retail operations and in-store reality while mastering modern IT tools. My mission is to ensure seamless modernization without external intermediaries, freeing up executive time for Management.",
    ...
    if (isDe) {
      return {
        ...
        roleMobile: "Mein Vorschlag ist es, als interne Vertrauensperson die Führungsvision mit der Ladenpraxis zu verbinden und die Gruppe ohne externe Agenturen oder Betriebsunterbrechungen zu modernisieren.",
        roleDesktopPrefix: "Um diese Phase zu leiten, schlage ich vor, als ",
        roleDesktopHighlight1: "operativer Innovations-Facilitator",
        roleDesktopMiddle: " zu agieren: eine ",
        roleDesktopHighlight2: "interne Vertrauensperson",
        roleDesktopEnd: ", die das Geschäft und die Praxis im Laden kennt und moderne IT-Werkzeuge beherrscht. Mein Ziel ist eine reibungslose Modernisierung ohne externe Dienstleister, um die Geschäftsführung spürbar zu entlasten.",
    ...
    return {
      ...
      roleMobile: "Mi propuesta es actuar como figura interna de confianza para conectar la visión de Dirección con la realidad de la tienda, modernizando el grupo sin intermediarios externos ni detener la actividad.",
      roleDesktopPrefix: "Para liderar esta etapa, mi propuesta es actuar como ",
      roleDesktopHighlight1: "facilitador de innovación operativa",
      roleDesktopMiddle: ": una ",
      roleDesktopHighlight2: "figura interna y de máxima confianza",
      roleDesktopEnd: " que conoce el negocio y la realidad de la tienda, y domina las herramientas IT. Mi labor es asegurar una modernización fluida, sin intermediarios externos y liberando tiempo y carga ejecutiva a la Dirección.",
